...
ent-ClothingNeckCloakRdAlt = research director's cloak
    .desc = A purple cape with white stripes, demonstrating your status as an arbiter of advanced technology, and perhaps style.
